...
os.chdir('/content/gdrive/My Drive/Colab Notebooks/globalwheat/input/efficientdet-pytorch-master')
...
class TrainGlobalConfig:
    ...
    folder = '/content/gdrive/My Drive/Colab Notebooks/globalwheat/input/efficientdet-pytorch-master/effdet5-cutmix-augmix2'
